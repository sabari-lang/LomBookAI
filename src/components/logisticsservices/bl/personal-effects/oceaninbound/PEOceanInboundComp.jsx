...
import { deletePEOceanInboundJob, getPEOceanInboundJobs } from "../../../../../services/personal-effects/oceanInboundService";
import { notifyError } from "../../../../../utils/notifications";

const PEOceanInboundComp = () => {
    ...
    const deleteMutation = useMutation({
        ...
        onSuccess: () => {
            queryClient.invalidateQueries({ queryKey: ["peOceanInboundJobs"] });
        },
    ...
    const { data: apiData, isLoading, isError } = useQuery({
        queryKey: ["peOceanInboundJobs"],
        queryFn: getPEOceanInboundJobs,
        retry: 1,
        staleTime: 1000 * 60 * 5,
    });
    ...
    return (
        <div className="container-fluid mt-3">
            <div className="d-flex justify-content-between align-items-center bg-primary text-white px-3 py-2 rounded-top">
                <h5 className="m-0">Personal Effects - Ocean Inbound</h5>
...
export default PEOceanInboundComp;
