...
import { deletePEOceanOutboundJob, getPEOceanOutboundClosedJobs } from "../../../../../services/personal-effects/oceanOutboundService";

const PEOceanOutboundClosedComp = () => {
    ...
    const deleteMutation = useMutation({
        ...
        onSuccess: () => {
            queryClient.invalidateQueries({ queryKey: ["peOceanOutboundClosedJobs"] });
        },
    ...
    const { data: apiData, isLoading, isError } = useQuery({
        queryKey: ["peOceanOutboundClosedJobs"],
        queryFn: getPEOceanOutboundClosedJobs,
        retry: 1,
        staleTime: 1000 * 60 * 5,
    });
    ...
    return (
        <div className="container-fluid mt-3">
            <div className="d-flex justify-content-between align-items-center bg-secondary text-white px-3 py-2 rounded-top">
                <h5 className="m-0">Personal Effects - Ocean Outbound (Closed)</h5>
            </div>
...
export default PEOceanOutboundClosedComp;
