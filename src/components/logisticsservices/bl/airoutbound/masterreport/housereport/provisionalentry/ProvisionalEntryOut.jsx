...
import {
    deleteAirOutboundProvisional,
    getAirOutboundProvisionals,
} from "../../../airOutboundApi";
        ...
        <>
            <div className="container-fluid tw-mt-4">
                ...
                <CommonSectionHeader
                    ...
                    onButtonClick={() =>
                        navigate("/air-outbound/masterreport/housereport/create-provisional")
                    }
                                            ...
                                            <tr key={row.id + idx}>
                                                ...
                                                <td className="text-center">
                                                    <button
                                                        ...
                                                        onClick={() =>
                                                            navigate(
                                                                "/air-outbound/masterreport/housereport/create-provisional",
                                                                { state: row.__raw }
                                                            )
                                                        }
                                                    >
