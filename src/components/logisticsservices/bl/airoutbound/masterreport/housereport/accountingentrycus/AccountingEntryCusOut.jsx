...
import { deleteAirOutboundCustomerAccount, getAirOutboundCustomerAccounts } from "../../../airOutboundApi";
...
const AccountingEntryCusOut = () => {
    ...
    const handleView = (row) => {
        ...
        navigate("/air-outbound/masterreport/housereport/view-customer-accounting");
    };
    ...
    return (
        <>
            <CommonSectionHeader
                title="Customer Accounting Entry (Air Outbound)"
