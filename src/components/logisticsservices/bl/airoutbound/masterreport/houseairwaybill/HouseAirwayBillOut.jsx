...
const HouseAirwayBillOut = () => {
    ...
    const { data: apiRaw, isLoading, isError } = useQuery({
        queryKey: ["airOutboundHouseList", jobNo, currentPage, entriesPerPage],
        queryFn: () =>
            getAirOutboundHouses(
                jobNo,
                {
                    page: currentPage,
    ...
    const deleteMutation = useMutation({
        mutationFn: ({ jobNo, hawb }) => deleteAirOutboundHouse(jobNo, hawb),
        onSuccess: () => {
    ...
    const statusUpdateMutation = useMutation({
        mutationFn: ({ jobNo, hawb, payload }) => updateAirOutboundHouseStatus(jobNo, hawb, payload),
        onSuccess: () => {
            queryClient.invalidateQueries({ queryKey: ["airOutboundHouseList", jobNo] });
            setEditData(null);
                                                    ...
                                                    <td>
                                                        ...
                                                        <button
                                                            ...
                                                            onClick={() => {
                                                                ...
                                                                navigate(
                                                                    "/air-outbound/masterreport/housereport"
                                                                );
                                                            }}
                                                        >
                                                            <FaEye />
