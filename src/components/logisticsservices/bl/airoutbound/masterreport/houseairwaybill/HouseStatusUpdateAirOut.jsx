...
const HouseStatusUpdateAirOut = ({ editData, setEditData, onSubmitStatus, isLoading = false }) => {
    ...
    return (
        <div
            ...
            id="airoutboundHouseStatusUpdateModal"
            tabIndex="-1"
            aria-hidden="true"
        >
                            ...
                            <div className="row g-3 mt-3">
                                <div className="col-md-4">
                                    ...
                                    <Controller
                                        name="cc1"
                                        control={control}
                                        render={({ field }) => <select className="form-select" {...field}></select>}
                                    />
                                </div>
...
export default HouseStatusUpdateAirOut;
