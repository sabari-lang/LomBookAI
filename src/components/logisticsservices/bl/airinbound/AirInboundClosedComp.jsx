...
import { deleteAirInboundJob, getAirInboundClosedJobs } from "./Api";
...
const AirInboundClosedComp = () => {
    ...
    const deleteMutation = useMutation({
        ...
        onSuccess: () => {
            queryClient.invalidateQueries({ queryKey: ["airInboundClosedJobs"] });
        },
    ...
    const { data: apiRaw, isLoading, isError } = useQuery({
        queryKey: ["airInboundClosedJobs", currentPage, entriesPerPage],
        queryFn: () =>
            getAirInboundClosedJobs({
                page: currentPage,
    ...
    return (
        <>
            <div className="container-fluid mt-3">
                ...
                >
                    <h5 className="m-0">Air Inbound - Closed</h5>
                </div>
