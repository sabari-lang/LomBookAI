        ...
        try {
            ...
            const incomeRows = incomeItems.map(item => `
                <tr>
                    ...
                    <td style="border:1px solid #000;padding:3px;text-align:right;">${formatCurrency(item.amountExRate)}</td>
                    <td style="border:1px solid #000;padding:3px;text-align:right;">${formatCurrency(item.exRate)}</td>
                    <td style="border:1px solid #000;padding:3px;text-align:right;">${formatCurrency(item.amountInr)}</td>
                    <td style="border:1px solid #000;padding:3px;text-align:right;">${formatCurrency(item.sgst)}</td>
                    <td style="border:1px solid #000;padding:3px;text-align:right;">${formatCurrency(item.cgst)}</td>
                    <td style="border:1px solid #000;padding:3px;text-align:right;">${formatCurrency(item.total)}</td>
                </tr>
            `).join("");
            ...
            tempDiv.innerHTML = `
                ...
                <div style="margin-bottom:10px;">
                    ...
                    <table style="width:100%;border-collapse:collapse;font-size:9px;">
                        ...
                        <tbody>
                            ${incomeRows || '<tr><td colspan="10" style="border:1px solid #000;padding:3px;text-align:center;">No income data</td></tr>'}
                            <tr style="font-weight:bold;">
                                <td colspan="4" style="border:1px solid #000;padding:3px;text-align:right;">Total</td>
                                <td style="border:1px solid #000;padding:3px;text-align:right;">${formatCurrency(incomeTotals.amountExRate)}</td>
                                <td style="border:1px solid #000;padding:3px;"></td>
                                <td style="border:1px solid #000;padding:3px;text-align:right;">${formatCurrency(incomeTotals.amountInr)}</td>
                                <td style="border:1px solid #000;padding:3px;text-align:right;">${formatCurrency(incomeTotals.sgst)}</td>
                                <td style="border:1px solid #000;padding:3px;text-align:right;">${formatCurrency(incomeTotals.cgst)}</td>
                                <td style="border:1px solid #000;padding:3px;text-align:right;">${formatCurrency(incomeTotals.total)}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                ...
                <div style="margin-bottom:10px;">
                    ...
                    <table style="width:100%;border-collapse:collapse;font-size:9px;">
                        ...
                        <tbody>
                            ${expenseRows || '<tr><td colspan="10" style="border:1px solid #000;padding:3px;text-align:center;">No expense data</td></tr>'}
                            <tr style="font-weight:bold;">
                                <td colspan="4" style="border:1px solid #000;padding:3px;text-align:right;">Total</td>
                                <td style="border:1px solid #000;padding:3px;text-align:right;">${formatCurrency(expenseTotals.amountExRate)}</td>
                                <td style="border:1px solid #000;padding:3px;"></td>
                                <td style="border:1px solid #000;padding:3px;text-align:right;">${formatCurrency(expenseTotals.amountInr)}</td>
                                <td style="border:1px solid #000;padding:3px;text-align:right;">${formatCurrency(expenseTotals.sgst)}</td>
                                <td style="border:1px solid #000;padding:3px;text-align:right;">${formatCurrency(expenseTotals.cgst)}</td>
                                <td style="border:1px solid #000;padding:3px;text-align:right;">${formatCurrency(expenseTotals.total)}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                ...
                <div style="margin-top:12px;">
                    ...
                    <table style="width:100%;border-collapse:collapse;font-size:9px;">
                        <thead>
                            <tr>
                                <th style="border:1px solid #000;padding:3px;text-align:left;font-weight:bold;">House Number</th>
