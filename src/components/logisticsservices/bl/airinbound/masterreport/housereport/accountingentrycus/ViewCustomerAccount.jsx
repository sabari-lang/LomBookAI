...
const ViewCustomerAccount = () => {
    ...
    const handlePrintExportInvoice = () => {
        ...
        // Company Header - Matching third image
        pdf.setFontSize(16);
        ...
        // Shipment Details Table - Two column layout matching image
        ...
        // Bank Details - Matching third image
        pdf.setFontSize(11);
        pdf.setFont("helvetica", "bold");
    ...
    // Print Digitally Signed - opens PHP endpoint in new tab
    ...
    return (
        <div className="container-fluid p-0" style={{ backgroundColor: "#f5f5f5", minHeight: "100vh" }} ref={printRef}>
            ...
            <div className="p-4" style={{ backgroundColor: "white", maxWidth: "1200px", margin: "0 auto" }}>
                ...
                {/* Bank Details Section - Matching third image */}
                <div className="mb-4">
