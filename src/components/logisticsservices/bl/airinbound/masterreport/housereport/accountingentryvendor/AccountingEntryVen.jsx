...
import RaisingEntryVendor from "./RaisingEntryVendor";
import { useNavigate } from "react-router-dom";

import {
    deleteAirInboundVendorAccount,
...
const AccountingEntryVen = () => {
    ...
    const { data: apiRaw, isLoading, isError } = useQuery({
        queryKey: ["airInboundVendorAccounts", jobNo, hawb, currentPage, pageSize],
        queryFn: () =>
            getAirInboundVendorAccounts(jobNo, hawb, {
                page: currentPage,
                pageSize,
            }),
    ...
    const normalize = (entry = {}) => {
        ...
        return {
            ...
            voucherNo: entry.voucherNo ?? "",   // ONE LINE (you confirmed option B)
            status: entry.status ?? "",
    ...
    const deleteMutation = useMutation({
        mutationFn: () => deleteAirInboundVendorAccount(jobNo, hawb),
    ...
    const handleView = (row) => {
        sessionStorage.setItem("vendorAccountViewData", JSON.stringify(row.__raw));
        navigate("/air-inbound/masterreport/housereport/view-vendor-account");
    };
    ...
    return (
        <>
            <CommonSectionHeader
                ...
                rightButton2ModalId="raiseVendorModal"
                                            ...
                                            <td className="text-center">
                                                <div className="d-flex justify-content-center gap-1">
                                                    <button
                                                        ...
                                                        data-bs-target="#raiseVendorModal"
            ...
            <RaisingEntryVendor editData={editData} setEditData={setEditData} />
        </>
    );
};

export default AccountingEntryVen;
