...
import { getOceanInboundCustomerAccountById } from "../../../oceanInboundApi";
...
const ViewCustomerAccountSeaIn = () => {
    ...
    useEffect(() => {
        ...
        // Ocean Inbound uses masterSeainData and houseSeainData
        const storedMaster = JSON.parse(sessionStorage.getItem("masterSeainData") || sessionStorage.getItem("masterAirwayData") || "{}");
        const storedHouse = JSON.parse(sessionStorage.getItem("houseSeainData") || sessionStorage.getItem("houseAirwayData") || "{}");
