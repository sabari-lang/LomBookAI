...
const HouseBillOfLaddingSeaInbound = () => {
    ...
    const { data: apiRaw, isLoading, isError } = useQuery({
        queryKey: ["oceanInboundHouseList", jobNo, currentPage, entriesPerPage],
        queryFn: () =>
            getOceanInboundHouses(jobNo, {
                page: currentPage,
    ...
    const deleteMutation = useMutation({
        mutationFn: ({ jobNo, hblNo }) => deleteOceanInboundHouse(jobNo, hblNo),
        onSuccess: () => {
    ...
    const statusUpdateMutation = useMutation({
        mutationFn: ({ jobNo, hblNo, payload }) => updateOceanInboundHouseStatus(jobNo, hblNo, payload),
        onSuccess: () => {
            queryClient.invalidateQueries({ queryKey: ["oceanInboundHouseList", jobNo] });
            setEditData(null);
                                                    ...
                                                    <td>
                                                        ...
                                                        <button
                                                            ...
                                                            onClick={() => {
                                                                ...
                                                                navigate(
                                                                    "/sea-inbound/masterreport/housereport"
                                                                );
                                                            }}
                                                        >
                                                            <FaEye />
