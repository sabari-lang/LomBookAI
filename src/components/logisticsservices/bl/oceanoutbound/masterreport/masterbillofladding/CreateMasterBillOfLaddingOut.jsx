...
import { UNIT_PKG_LIST } from "../../../../../../utils/unitPkgList";
...
const CreateMasterBillOfLaddingOut = () => {
    ...
    // useFieldArray for product/line rows if you want to allow dynamic lines later
                        ...
                        <div className="col-md-6">
                            ...
                            <div className="mb-3">
                                ...
                                <div className="d-flex gap-3 small mb-2">
                                    ...
                                    <label><input type="checkbox" className="me-1" onChange={(e) => handleCopyAs(e.target.checked)} /> COPY AS</label>
                                </div>
...
export default CreateMasterBillOfLaddingOut;
