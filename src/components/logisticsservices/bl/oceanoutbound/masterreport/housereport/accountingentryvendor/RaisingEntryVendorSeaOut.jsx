...
const RaisingEntryVendorSeaOut = ({ editData, setEditData }) => {
  ...
  const createMutation = useMutation({
    mutationFn: ({ jobNo, hblNo, payload }) =>
      createOceanOutboundVendorAccount(jobNo, hblNo, payload),

    onError: (err) =>
      handleProvisionalError(err, "Create Ocean Outbound Vendor Accounting"),
  ...
  const updateMutation = useMutation({
    mutationFn: ({ jobNo, hblNo, payload }) =>
      updateOceanOutboundVendorAccount(jobNo, hblNo, payload),

    onError: (err) =>
      handleProvisionalError(err, "Update Ocean Outbound Vendor Accounting"),
  ...
  const onSubmit = (data) => {
    ...
    if (isEditing) {
      updateMutation.mutate({ jobNo, hblNo, payload });
    } else {
      createMutation.mutate({ jobNo, hblNo, payload });
    }
  };
