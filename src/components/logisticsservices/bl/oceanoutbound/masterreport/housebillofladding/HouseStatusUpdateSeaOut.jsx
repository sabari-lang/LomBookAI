...
const HouseStatusUpdateSeaOut = ({ editData, setEditData, onSubmitStatus, isLoading = false }) => {
    ...
    return (
        <div
            ...
            id="seaoutboundHouseStatusUpdateModal"
            tabIndex="-1"
            aria-hidden="true"
                        ...
                        <div className="modal-body" style={{ maxHeight: "75vh", overflowY: "auto" }}>
                            ...
                            <div className="row g-3 mt-3">
                                <div className="col-md-4">
                                    ...
                                    <input className="form-control" {...register("invoiceValue")} />
                                </div>
                            ...
                            {/* ⭐ NEW ROW – CLEARANCE DATE + JOB CLOSE DATE */}
                            <div className="row g-3 mt-3">
                                <div className="col-md-4">
...
export default HouseStatusUpdateSeaOut;
