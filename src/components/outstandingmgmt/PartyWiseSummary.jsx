...
import { getPartyWiseSummary, viewReportUrl } from "./outstandingAPI";
...
const PartyWiseSummary = () => {
    ...
    const handleViewReport = () => {
        ...
        const url = viewReportUrl("/outstanding/party-wise", { fromMonth, toMonth });
        ...
        <div className="container-fluid p-0">
            <div className="card shadow-sm m-3">
                ...
                <div className="d-flex justify-content-end px-3 pt-2 small text-muted">
                    <nav aria-label="breadcrumb">
                        <ol className="breadcrumb mb-0">
                            ...
                            <li className="breadcrumb-item active" aria-current="page">Summary Party Wise Report</li>
                        </ol>
                    </nav>
                </div>
                ...
                <div className="px-3 py-2 fw-semibold bg-warning text-dark">
                    <h5 className="m-0">Summary Party Wise Report</h5>
                </div>
