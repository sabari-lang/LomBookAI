...
import { getGstrTwoReport } from "../reportAPI";
...
const GSTTwo = () => {
        const [fromMonth, setFromMonth] = useState("2025-11");
        ...
        const queryKey = useMemo(
                () => ["report-gstr-two", fromMonth, toMonth, page, perPage],
                [fromMonth, toMonth, page, perPage]
        );

        const { data: fetched, isLoading } = useQuery({
                queryKey,
                queryFn: () => getGstrTwoReport(requestParams),
                enabled: Boolean(fromMonth && toMonth),
                keepPreviousData: true,
                retry: 1,
                onError: (error) => handleProvisionalError(error, "GSTR-2"),
        });
        ...
        const downloadExcel = () => {
                ...
                XLSX.writeFile(workbook, `GSTR2_${fromMonth}_${toMonth}.xlsx`);
        };
        ...
        const generatePDF = async () => {
                ...
                <div class="section-title">Purchase / Expense</div>
                <table>
                    <thead>
                        <tr>
                            <th>GSTIN/UIN</th>
        ...
        const handleAction = (action) => {
                ...
                if (action === "open") window.open(pdfUrl, "_blank");
                        ...
                        link.href = pdfUrl;
                        link.download = "GSTR2_Report.pdf";
                        link.click();
                        ...
                        const subject = encodeURIComponent("GSTR2 Report");
                        const body = encodeURIComponent("Please find attached your GSTR2 Report.");
        ...
        return (
                ...
                >
                        ...
                        >
                                <h6 className="fw-bold mb-3">GSTR2 REPORT</h6>
                                <DataTable
                                        columns={columns}
                                        data={tableRows}
                                        pagination
