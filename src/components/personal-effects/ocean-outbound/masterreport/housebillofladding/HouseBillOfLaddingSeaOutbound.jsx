...
import { getUbOceanOutboundHouses, deleteUbOceanOutboundHouse, updateUbOceanOutboundHouseStatus } from "../../../../../services/personal-effects/oceanOutbound/peOceanOutboundApi";
...
const HouseBillOfLaddingSeaOutbound = () => {
    ...
    const { data: apiRaw, isLoading, isError } = useQuery({
        queryKey: ["peUbOceanOutboundHouses", jobNo, currentPage, entriesPerPage],
        queryFn: () =>
            getUbOceanOutboundHouses(jobNo, {
                page: currentPage,
    ...
    const deleteMutation = useMutation({
        mutationFn: ({ jobNo, hblNo }) => deleteUbOceanOutboundHouse(jobNo, hblNo),
        onSuccess: () => {
            queryClient.invalidateQueries({ queryKey: ["peUbOceanOutboundHouses", jobNo] });
        },
    });

    // Status update mutation
    const statusUpdateMutation = useMutation({
        mutationFn: ({ jobNo, hblNo, payload }) => updateUbOceanOutboundHouseStatus(jobNo, hblNo, payload),
        onSuccess: () => {
            queryClient.invalidateQueries({ queryKey: ["peUbOceanOutboundHouses", jobNo] });
            setEditData(null);
                                                    ...
                                                    <td>
                                                        ...
                                                        <button
                                                            ...
                                                            onClick={() => {
                                                                ...
                                                                navigate(
                                                                    "/pe/ocean-outbound/masterreport/housereport"
                                                                );
                                                            }}
                                                        >
                                                            <FaEye />
