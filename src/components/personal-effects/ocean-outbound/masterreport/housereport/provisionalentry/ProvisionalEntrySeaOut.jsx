...
const ProvisionalEntrySeaOut = () => {
    ...
    const deleteMutation = useMutation({
        mutationFn: () => deleteOceanOutboundProvisional(jobNo, hbl),
        onSuccess: () => {
            notifySuccess("UB Ocean Outbound Provisional Entry Deleted");
        ...
        <>
            <div className="container-fluid tw-mt-4">
                ...
                <CommonSectionHeader
                    ...
                    onButtonClick={() =>
                        navigate("/pe/ocean-outbound/masterreport/housereport/create-provisional")
                    }
                                            ...
                                            <tr key={row.id + "_" + idx}>
                                                ...
                                                <td className="text-center">
                                                    <button
                                                        ...
                                                        onClick={() =>
                                                            navigate(
                                                                "/pe/ocean-outbound/masterreport/housereport/create-provisional",
                                                                { state: row.__raw }
                                                            )
                                                        }
                                                    >
