...
import { createUbOceanOutboundCustomerAccount, updateUbOceanOutboundCustomerAccount, getUbOceanOutboundProvisionals } from "../../../../../../services/personal-effects/oceanOutbound/peOceanOutboundApi";
...
const RaiseAccountingEntrySeaOut = ({ editData, setEditData }) => {
    ...
    const { data: provisionalApiRaw } = useQuery({
        queryKey: ["oceanOutboundProvisionals", ubId],
        queryFn: () => getUbOceanOutboundProvisionals(ubId, { page: 1, pageSize: 1000 }),
    ...
    const createMutation = useMutation({
        mutationFn: (payload) => createUbOceanOutboundCustomerAccount(ubId, payload),
        onSuccess: () => {
            queryClient.invalidateQueries(["oceanOutboundCustomerAccounts", ubId]);
            notifySuccess("UB Ocean Outbound customer accounting entry created");
            closeModal();
        },
    ...
    const updateMutation = useMutation({
        mutationFn: (payload) => updateUbOceanOutboundCustomerAccount(ubId, payload),
        onSuccess: () => {
            queryClient.invalidateQueries(["oceanOutboundCustomerAccounts", ubId]);
            notifySuccess("UB Ocean Outbound customer accounting entry updated");
            closeModal();
        },
