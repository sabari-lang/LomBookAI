...
import { createUbOceanOutboundProvisional, updateUbOceanOutboundProvisional } from "../../../../../../services/personal-effects/oceanOutbound/peOceanOutboundApi";
...
const CreateProvisionalEntrySeaOut = () => {
    ...
    const createMutation = useMutation({
        mutationFn: (payload) => createUbOceanOutboundProvisional(ubId, payload),
        onSuccess: () => {
            queryClient.invalidateQueries(["oceanOutboundProvisionals", ubId]);
    ...
    const updateMutation = useMutation({
        mutationFn: (payload) => updateUbOceanOutboundProvisional(ubId, payload),
        onSuccess: () => {
            queryClient.invalidateQueries(["oceanOutboundProvisionals", ubId]);
            queryClient.invalidateQueries(["oceanOutboundProvisionals", jobNo, hblNo]);
