...
import { getUbOceanOutboundCustomerAccountById } from "../../../../../../services/personal-effects/oceanOutbound/peOceanOutboundApi";
...
const ViewCustomerAccountSeaOut = () => {
    ...
    const { data: fullEntryData } = useQuery({
        ...
        queryFn: () => getUbOceanOutboundCustomerAccountById(entryData?.id),
