...
import { getUbOceanOutboundVendorAccounts } from "../../../../../../services/personal-effects/oceanOutbound/peOceanOutboundApi";


const AccountingVendorDetailSeaOut = () => {
    ...
    const { data: apiRaw, isLoading, isError } = useQuery({
        queryKey: ["oceanOutboundVendor", ubId, currentPage, pageSize],
        queryFn: () =>
...
export default AccountingVendorDetailSeaOut;
