...
import { getUbOceanOutboundCustomerAccounts } from "../../../../../../services/personal-effects/oceanOutbound/peOceanOutboundApi";
...
const AccountingCustomerDetailSeaOut = () => {
    ...
    const { data: apiRaw, isLoading, isError } = useQuery({
        queryKey: ["oceanOutboundCustomerAccDetail", ubId, currentPage, pageSize],
        queryFn: () =>
