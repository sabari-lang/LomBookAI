...
import { getUbOceanOutboundVendorAccountById } from "../../../../../../services/personal-effects/oceanOutbound/peOceanOutboundApi";
...
const ViewVendorAccountSeaOut = () => {
    ...
    useEffect(() => {
        const stored = sessionStorage.getItem("vendorSeaOutViewData");
        if (stored) {
            try {
                const data = JSON.parse(stored);
                setEntryData(data);
            } catch (e) {
                console.error("Error parsing vendorSeaOutViewData:", e);
            }
        }
    ...
    const { data: fullEntryData } = useQuery({
        queryKey: ["oceanOutboundVendorAccountEntry", entryData?.id],
        queryFn: () => getUbOceanOutboundVendorAccountById(entryData?.id),
...
export default ViewVendorAccountSeaOut;
