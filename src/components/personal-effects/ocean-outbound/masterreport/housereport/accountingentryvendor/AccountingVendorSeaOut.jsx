...
import { deleteUbOceanOutboundVendorAccount, getUbOceanOutboundVendorAccounts } from "../../../../../../services/personal-effects/oceanOutbound/peOceanOutboundApi";
...
const AccountingVendorSeaOut = () => {
    ...
    // UB Ocean Outbound SessionStorage Loaded Values
    ...
    const { data: apiRaw, isLoading, isError } = useQuery({
        ...
        queryFn: () =>
            getUbOceanOutboundVendorAccounts(ubId, {
                page: currentPage,
                pageSize,
            }),
    ...
    const deleteMutation = useMutation({
        mutationFn: () => deleteUbOceanOutboundVendorAccount(ubId),
    ...
    const handleDelete = async (row) => {
        if (!ubId) {
            notifyError("Shipment ID (ubId) is required for deletion");
            return;
        }
    ...
    const handleView = (row) => {
        ...
        navigate("/pe/ocean-outbound/vendor-view");
    };
