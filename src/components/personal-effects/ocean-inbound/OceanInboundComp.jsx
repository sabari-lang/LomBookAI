...
import {
    deleteUbOceanInboundJob,
    getUbOceanInboundJobs,
} from "../../../services/personal-effects/oceanInbound/peOceanInboundApi"; // <-- You will create this API
...
const OceanInboundComp = () => {
    ...
    const deleteMutation = useMutation({
        mutationFn: deleteUbOceanInboundJob,
        onSuccess: () => {
            queryClient.invalidateQueries({ queryKey: ["pe-ub-ocean-inbound-master"] });
        },
    ...
    const handleDelete = async (row = {}) => {
        ...
        if (!jobNo) return;
        const confirmed = await confirm(`Delete UB Ocean Inbound job ${jobNo}?`);
    if (!confirmed) return;
    ...
    const { data: apiData, isLoading, isError } = useQuery({
        queryKey: ["pe-ub-ocean-inbound-master"],
        queryFn: getUbOceanInboundJobs,
        retry: 1,
        staleTime: 1000 * 60 * 5,
    });
        ...
        <>
            <div className="container-fluid mt-3">
                ...
                <div className="d-flex justify-content-between align-items-center bg-primary text-white px-3 py-2 rounded-top">
                    <h5 className="m-0">UB Ocean Inbound</h5>

                    <button
                        className="btn btn-success btn-sm"
                        data-bs-toggle="modal"
                        data-bs-target="#peOceanInCreateJobModal"
                ...
                <div className="p-3 border border-top-0 rounded-bottom bg-white">
                    ...
                    <div className="table-responsive" style={{ maxHeight: "60vh", overflowY: "auto" }}>
                        <table className="table table-bordered table-striped table-hover mb-0">
                            ...
                            navigate("/pe/ocean-inbound/masterreport");
                                                    }}
                                                >
