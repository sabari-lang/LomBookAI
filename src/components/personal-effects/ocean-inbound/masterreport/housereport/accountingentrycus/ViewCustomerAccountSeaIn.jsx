...
import { getOceanInboundCustomerAccountById } from "../../../../../../services/personal-effects/oceanInbound/peOceanInboundApi";
...
const ViewCustomerAccountSeaIn = () => {
    ...
    useEffect(() => {
        const stored = sessionStorage.getItem("customerAccViewSeaIn");
        if (stored) {
            try {
                const data = JSON.parse(stored);
                setEntryData(data);
            } catch (e) {
                console.error("Error parsing customerAccViewSeaIn:", e);
            }
        }

        // UB Ocean Inbound uses masterSeainData and houseSeainData
        const storedMaster = JSON.parse(sessionStorage.getItem("masterSeainData") || sessionStorage.getItem("peUbMasterBillOfLaddingData") || "{}");
        const storedHouse = JSON.parse(sessionStorage.getItem("houseSeainData") || sessionStorage.getItem("peUbHouseBillOfLaddingData") || "{}");
    ...
    const { data: fullEntryData } = useQuery({
        queryKey: ["oceanInboundCustomerAccountEntry", entryData?.id],
        queryFn: () => getOceanInboundCustomerAccountById(entryData?.id),
    ...
    // Generate PDF Preview for Invoice
    const handlePrintInvoice = async () => {
        const element = document.getElementById('invoice-print-content-seain');
        if (!element) return;
    ...
    return (
        <div className="container-fluid p-3" style={{ backgroundColor: "#f5f5f5", minHeight: "100vh" }} ref={printRef}>
            ...
            {/* Main Content - Accounting Entry Details Layout */}
            <div className="p-4 accounting-entry-print" style={{ backgroundColor: "transparent", maxWidth: "1200px", margin: "0 auto" }}>
                ...
                <div className="row mb-4">
                    <div className="col-md-6">
                        <table className="table table-bordered table-sm" style={{ fontSize: "13px", marginBottom: 0 }}>
                            <tbody>
                                <tr>
                                    <td style={{ width: "45%", fontWeight: "bold", padding: "8px" }}>Job No / Ref No</td>
                                ...
                                <tr>
                                    <td style={{ fontWeight: "bold", padding: "8px" }}>Vessel Name / Voy</td>
                                    <td style={{ padding: "8px" }}>{vesselName}</td>
                                </tr>
                                <tr>
                                    <td style={{ fontWeight: "bold", padding: "8px" }}>Package / Grossweight</td>
                                    <td style={{ padding: "8px" }}>{noOfPackages}/{grossWeight} Kgs</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td style={{ fontWeight: "bold", padding: "8px" }}>Shipper Invoice Amount</td>
                    ...
                    <div className="col-md-6">
                        <table className="table table-bordered table-sm" style={{ fontSize: "13px", marginBottom: 0 }}>
                            <tbody>
                                <tr>
                                    <td style={{ width: "45%", fontWeight: "bold", padding: "8px" }}>Voucher Date</td>
                                ...
                                <tr>
                                    <td style={{ fontWeight: "bold", padding: "8px" }}>Port of loading</td>
                                    <td style={{ padding: "8px" }}>{origin}</td>
                                </tr>
                                <tr>
                                    <td style={{ fontWeight: "bold", padding: "8px" }}>Place of Destination</td>
                                    <td style={{ padding: "8px" }}>{destination}</td>
                                </tr>
                                <tr>
                                    <td style={{ fontWeight: "bold", padding: "8px" }}>Measurement</td>
                                    <td style={{ padding: "8px" }}>{masterData?.measurement || ""} CBM</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td style={{ fontWeight: "bold", padding: "8px" }}>Container</td>
                                    <td style={{ padding: "8px" }}>{masterData?.container || ""}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                    ...
                    <table className="table table-bordered" style={{ fontSize: "13px", width: "100%" }}>
                        <thead className="table-light">
                            <tr>
                                ...
                                <th style={{ width: "25%", padding: "8px", textAlign: "right" }}>Credit</th>
                            </tr>
                        </thead>
                        <tbody>
                            {items.length === 0 ? (
                ...
                <div className="mb-4">
                    <table className="table table-bordered table-sm" style={{ fontSize: "13px" }}>
                        <tbody>
                            <tr>
                                <td style={{ width: "15%", fontWeight: "bold", padding: "8px", backgroundColor: "#f8f9fa" }}>Remarks</td>
                                <td style={{ padding: "8px" }} colSpan="3">{displayData?.remark || ""}</td>
                            </tr>
                            <tr>
                                <td style={{ fontWeight: "bold", padding: "8px", backgroundColor: "#f8f9fa" }}>Created by</td>
                                <td style={{ padding: "8px", width: "35%" }}>{displayData?.createdBy || ""}</td>
                                <td style={{ fontWeight: "bold", padding: "8px", backgroundColor: "#f8f9fa", width: "15%" }}>Created On</td>
                                <td style={{ padding: "8px", width: "35%" }}>{formatDate(displayData?.createdAt || displayData?.createdOn)}</td>
                            </tr>
                            <tr>
                                <td style={{ fontWeight: "bold", padding: "8px", backgroundColor: "#f8f9fa" }}>Cancelled Remarks</td>
                                <td style={{ padding: "8px" }} colSpan="3">{displayData?.cancelledRemarks || ""}</td>
                            </tr>
                            <tr>
                                <td style={{ fontWeight: "bold", padding: "8px", backgroundColor: "#f8f9fa" }}>Cancelled by</td>
                                <td style={{ padding: "8px" }}>{displayData?.cancelledBy || ""}</td>
                                <td style={{ fontWeight: "bold", padding: "8px", backgroundColor: "#f8f9fa" }}>Cancelled On</td>
                                <td style={{ padding: "8px" }}>{formatDate(displayData?.cancelledOn)}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
            ...
            <div id="invoice-print-content-seain" style={{ 
                position: 'absolute', 
                left: '-9999px', 
                top: 0, 
                width: '210mm', 
                ...
                <table style={{ width: '100%', marginBottom: '8px', border: '1px solid #000', borderCollapse: 'collapse', fontSize: '10px' }}>
                    <tbody>
                        ...
                        <tr>
                            <td style={{ border: '1px solid #000', padding: '5px', fontWeight: 'bold' }}>Gstin</td>
                            <td style={{ border: '1px solid #000', padding: '5px' }}>{gstin}</td>
                            <td style={{ border: '1px solid #000', padding: '5px', fontWeight: 'bold', width: '12%' }}>ATTN</td>
                            <td style={{ border: '1px solid #000', padding: '5px', width: '38%' }}>{attn}</td>
                        </tr>
                        <tr>
                            <td style={{ border: '1px solid #000', padding: '5px', fontWeight: 'bold' }} colSpan="2"></td>
                            <td style={{ border: '1px solid #000', padding: '5px', fontWeight: 'bold' }}>TEL/FAX</td>
                            <td style={{ border: '1px solid #000', padding: '5px' }}>{tel} {fax && `/ ${fax}`}</td>
                        </tr>
                    </tbody>
                </table>
                ...
                <table style={{ width: '100%', marginBottom: '8px', border: '1px solid #000', borderCollapse: 'collapse', fontSize: '9px' }}>
                    <tbody>
                        <tr>
                            <td style={{ border: '1px solid #000', padding: '4px', fontWeight: 'bold', width: '18%' }}>Job No / Ref No</td>
                        ...
                        <tr>
                            <td style={{ border: '1px solid #000', padding: '4px', fontWeight: 'bold' }}>M.B/L No</td>
                        ...
                        <tr>
                            <td style={{ border: '1px solid #000', padding: '4px', fontWeight: 'bold' }}>H.B/L No</td>
                            <td style={{ border: '1px solid #000', padding: '4px' }}>{hblNo}</td>
                            <td style={{ border: '1px solid #000', padding: '4px', fontWeight: 'bold' }}>E.T.D</td>
                        ...
                        <tr>
                            ...
                            <td style={{ border: '1px solid #000', padding: '4px', fontWeight: 'bold' }}>E.T.A</td>
                        ...
                        <tr>
                            <td style={{ border: '1px solid #000', padding: '4px', fontWeight: 'bold' }}>Package / Grossweight</td>
                            <td style={{ border: '1px solid #000', padding: '4px' }}>{noOfPackages}/{grossWeight} KG</td>
                            <td style={{ border: '1px solid #000', padding: '4px', fontWeight: 'bold' }}>Measurement</td>
                            <td style={{ border: '1px solid #000', padding: '4px' }}>{masterData?.measurement || ''}</td>
                        </tr>
                        <tr>
                            <td style={{ border: '1px solid #000', padding: '4px', fontWeight: 'bold' }}>Be No</td>
                            <td style={{ border: '1px solid #000', padding: '4px' }}>{beNo}</td>
                            <td style={{ border: '1px solid #000', padding: '4px', fontWeight: 'bold' }}>Be Date</td>
                            <td style={{ border: '1px solid #000', padding: '4px' }}>{beDate}</td>
                        </tr>
                        <tr>
                            <td style={{ border: '1px solid #000', padding: '4px', fontWeight: 'bold' }}>Invoice Value</td>
                            <td style={{ border: '1px solid #000', padding: '4px' }}>{invoiceValue}</td>
                            <td style={{ border: '1px solid #000', padding: '4px', fontWeight: 'bold' }}>Assesable Value</td>
                            <td style={{ border: '1px solid #000', padding: '4px' }}>{assessableValue}</td>
                        </tr>
                        <tr>
                            <td style={{ border: '1px solid #000', padding: '4px', fontWeight: 'bold' }}>Shipper Invoice No</td>
                            <td style={{ border: '1px solid #000', padding: '4px' }}>{shipperInvoiceNo}</td>
                            <td style={{ border: '1px solid #000', padding: '4px', fontWeight: 'bold' }}>Shipper Invoice Date</td>
                            <td style={{ border: '1px solid #000', padding: '4px' }}>{shipperInvoiceDate}</td>
                        </tr>
                        <tr>
                            <td style={{ border: '1px solid #000', padding: '4px', fontWeight: 'bold' }}>Shipper Invoice Amount</td>
                            <td style={{ border: '1px solid #000', padding: '4px' }}>{shipperInvoiceAmount}</td>
                        ...
                        <tr>
                            <td style={{ border: '1px solid #000', padding: '4px', fontWeight: 'bold' }} colSpan="2"></td>
                            <td style={{ border: '1px solid #000', padding: '4px', fontWeight: 'bold' }}>Container</td>
                            <td style={{ border: '1px solid #000', padding: '4px' }}>{masterData?.container || ''}</td>
                        </tr>
                    </tbody>
                </table>
                ...
                <table style={{ width: '100%', marginBottom: '8px', border: '1px solid #000', borderCollapse: 'collapse', fontSize: '9px' }}>
                    <thead>
                        <tr>
                            <th style={{ border: '1px solid #000', padding: '5px', textAlign: 'left', backgroundColor: '#f5f5f5', fontWeight: 'bold', width: '10%' }}>Code</th>
                            ...
                            <th style={{ border: '1px solid #000', padding: '5px', textAlign: 'right', backgroundColor: '#f5f5f5', width: '18%', fontWeight: 'bold' }}>Credit</th>
                        </tr>
                    </thead>
                    <tbody>
                        {items.length === 0 ? (
                            ...
                            items.map((item, index) => (
                                <tr key={index}>
                                    <td style={{ border: '1px solid #000', padding: '4px' }}>{item?.code || ''}</td>
                        ...
                        {items.length > 0 && (
                            <tr>
                                <td colSpan="3" style={{ border: '1px solid #000', padding: '5px', textAlign: 'right', fontWeight: 'bold' }}>Total</td>
                ...
                <table style={{ width: '100%', border: '1px solid #000', borderCollapse: 'collapse', fontSize: '9px' }}>
                    <tbody>
                        <tr>
                            <td style={{ border: '1px solid #000', padding: '5px', fontWeight: 'bold', width: '12%' }}>Remarks</td>
                            <td style={{ border: '1px solid #000', padding: '5px' }}>{displayData?.remark || ''}</td>
                        </tr>
                        <tr>
                            <td style={{ border: '1px solid #000', padding: '5px', fontWeight: 'bold' }}>Created by</td>
                            <td style={{ border: '1px solid #000', padding: '5px' }}>{displayData?.createdBy || ''}</td>
                            <td style={{ border: '1px solid #000', padding: '5px', fontWeight: 'bold', width: '15%' }}>Created On</td>
                            <td style={{ border: '1px solid #000', padding: '5px', width: '25%' }}>{formatDate(displayData?.createdAt || displayData?.createdOn)}</td>
                        </tr>
                        <tr>
                            <td style={{ border: '1px solid #000', padding: '5px', fontWeight: 'bold' }}>Cancelled Remarks</td>
                            <td style={{ border: '1px solid #000', padding: '5px' }}>{displayData?.cancelledRemarks || ''}</td>
                        </tr>
                        <tr>
                            <td style={{ border: '1px solid #000', padding: '5px', fontWeight: 'bold' }}>Cancelled by</td>
                            <td style={{ border: '1px solid #000', padding: '5px' }}>{displayData?.cancelledBy || ''}</td>
                            <td style={{ border: '1px solid #000', padding: '5px', fontWeight: 'bold' }}>Cancelled On</td>
                            <td style={{ border: '1px solid #000', padding: '5px' }}>{formatDate(displayData?.cancelledOn)}</td>
                        </tr>
                    </tbody>
                </table>
            </div>
...
export default ViewCustomerAccountSeaIn;
