...
import { createOceanInboundArrivalNotice, updateOceanInboundArrivalNotice, getOceanInboundProvisionals } from "../../../../../../services/personal-effects/oceanInbound/peOceanInboundApi";
...
const CreateArrivalNoticeSeaIn = ({ editData, setEditData }) => {
    ...
    // Fetch provisional entries to map to charges (like UB Air Inbound)
    ...
    // Auto-fill default values from master and house data (like UB Air Inbound)
    ...
    // --- Initialization logic (like UB Air Inbound) ---
