...
const ProvisionalEntrySeaIn = () => {
    ...
    // RAW ENTRY MAP (same as UB Air Inbound)
    ...
    // NORMALIZE (same as UB Air Inbound)
    ...
    const deleteMutation = useMutation({
        ...
        onSuccess: () => {
            notifySuccess("UB Ocean Inbound Provisional Entry Deleted");
        ...
        <>
            <div className="container-fluid tw-mt-4">
                ...
                <CommonSectionHeader
                    ...
                    onButtonClick={() =>
                        navigate("/pe/ocean-inbound/masterreport/housereport/create-provisional")
                    }
                                            ...
                                            <tr key={row.id + "_" + idx}>
                                                ...
                                                <td className="text-center">
                                                    <button
                                                        ...
                                                        onClick={() =>
                                                            navigate(
                                                                "/pe/ocean-inbound/masterreport/housereport/create-provisional",
                                                                { state: row.__raw }
                                                            )
                                                        }
                                                    >
