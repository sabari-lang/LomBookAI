// src/components/logisticsservices/bl/oceaninbound/masterreport/housereport/RaiseAccountingEntrySeaIn.jsx
...
import { createOceanInboundCustomerAccount, updateOceanInboundCustomerAccount, getOceanInboundProvisionals } from "../../../../../../services/personal-effects/oceanInbound/peOceanInboundApi";
...
const RaiseAccountingEntrySeaIn = ({ editData, setEditData }) => {
    const queryClient = useQueryClient();

    // --- Session Data ---
    // Use masterAirwayData and houseAirwayData for consistency with list component
    ...
    // Default form values - auto-filled from master/house data
    const defaultValues = {
        voucherType: "",
        voucherNo: "",
        voucherDate: "",
    ...
    const closeModal = () => {
        ...
        const modalElement = document.getElementById("SeaInRaiseAccountingModal");
        if (modalElement) {
    ...
    const createMutation = useMutation({
        ...
        onSuccess: () => {
            ...
            notifySuccess("UB Ocean Inbound customer accounting entry created");
            closeModal();
        },
    ...
    const updateMutation = useMutation({
        ...
        onSuccess: () => {
            queryClient.invalidateQueries(["oceanInboundCustomerAcc", jobNo, hblNo]);
            notifySuccess("UB Ocean Inbound customer accounting entry updated");
            closeModal();
        },
...
export default RaiseAccountingEntrySeaIn;
