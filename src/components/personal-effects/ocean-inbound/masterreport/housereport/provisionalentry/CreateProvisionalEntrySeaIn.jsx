// /mnt/data/CreateProvisionalEntrySeaIn.jsx
...
import { createOceanInboundProvisional, updateOceanInboundProvisional } from "../../../../../../services/personal-effects/oceanInbound/peOceanInboundApi";
...
const CreateProvisionalEntrySeaIn = () => {
    ...
    // Only track INPUT fields → prevent infinite loop
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="tw-mt-4">
                ...
                <div className="row g-3 mt-2">
                    ...
                    <div className="col-md-4">
                        ...
                        <Controller name="hblNo" control={control} render={({ field }) => <input {...field} readOnly className="form-control bg-light" />} />
                    </div>
...
export default CreateProvisionalEntrySeaIn;
