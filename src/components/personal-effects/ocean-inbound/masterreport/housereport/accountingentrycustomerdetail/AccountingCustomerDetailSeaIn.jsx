...
import { getOceanInboundCustomerAccounts } from "../../../../../../services/personal-effects/oceanInbound/peOceanInboundApi";

const AccountingCustomerDetailSeaIn = () => {
    ...
    const { data: apiRaw, isLoading, isError } = useQuery({
        queryKey: ["oceanInboundCustomerAcc", jobNo, hblNo, currentPage, pageSize],
        queryFn: () =>
                    ...
                    <div className="d-flex justify-content-between mb-3">
                        ...
                        <div className="d-flex align-items-center gap-2">
                            ...
                            <input
                                ...
                                title="Search by voucher date, HBL, description or SAC"
                            />
                        </div>
                    </div>
...
export default AccountingCustomerDetailSeaIn;
