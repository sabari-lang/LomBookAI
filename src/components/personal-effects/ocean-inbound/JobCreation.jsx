...
import { createUbOceanInboundJob, updateUbOceanInboundJob } from "../../../services/personal-effects/oceanInbound/peOceanInboundApi";
...
const JobCreation = ({ editData, setEditData }) => {
    ...
    const handleCloseModal = () => {
        reset(initialValues);
        setEditData?.(null);
        closeModalUtil("peOceanInCreateJobModal");
    ...
    const createMutation = useMutation({
        mutationFn: createUbOceanInboundJob,
        onSuccess: () => {
            queryClient.invalidateQueries(["pe-ub-ocean-inbound-master"]);
    ...
    const updateMutation = useMutation({
        mutationFn: ({ id, payload }) => updateUbOceanInboundJob(id, payload),
        onSuccess: () => {
            queryClient.invalidateQueries(["pe-ub-ocean-inbound-master"]);
    ...
    return (
        <>
            <div className="modal fade" id="peOceanInCreateJobModal" tabIndex="-1" aria-hidden="true" data-bs-backdrop="static">
