...
import { getUbAirInboundHouses, deleteUbAirInboundHouse, updateUbAirInboundHouseStatus } from "../../../../../services/personal-effects/airInbound/peAirInboundApi";
...
const HouseAirwaybill = () => {
    ...
    const { data: apiRaw, isLoading, isError } = useQuery({
        queryKey: ["peUbAirInboundHouses", jobNo, currentPage, entriesPerPage],
        queryFn: () =>
            getUbAirInboundHouses(jobNo, {
                page: currentPage,
    ...
    const deleteMutation = useMutation({
        mutationFn: ({ jobNo, hawb }) => deleteUbAirInboundHouse(jobNo, hawb),
        onSuccess: () => {
            queryClient.invalidateQueries({ queryKey: ["peUbAirInboundHouses", jobNo] });
        },
    });
    ...
    const statusUpdateMutation = useMutation({
        mutationFn: ({ jobNo, hawb, payload }) => updateUbAirInboundHouseStatus(jobNo, hawb, payload),
        onSuccess: () => {
            queryClient.invalidateQueries({ queryKey: ["peUbAirInboundHouses", jobNo] });
            setEditData(null);
                                                ...
                                                <td>
                                                    ...
                                                    <button
                                                        ...
                                                        onClick={() => {
                                                            ...
                                                            navigate(
                                                                "/pe/air-inbound/masterreport/housereport"
                                                            );
                                                        }}
                                                    >
                                                        <FaEye />
