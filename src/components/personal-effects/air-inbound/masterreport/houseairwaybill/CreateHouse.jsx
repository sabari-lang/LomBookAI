...
// import { createUbAirInboundHouse, updateUbAirInboundHouse } from "../../../../services/personal-effects/airInbound/peAirInboundApi";
...
const CreateHouse = ({ editData, setEditData }) => {
    ...
    const createHouseMutation = useMutation({
        mutationFn: ({ jobNo, payload }) =>
            createUbAirInboundHouse(jobNo, payload),

        onSuccess: () => {
            queryClient.invalidateQueries(["peUbAirInboundHouses", jobNo]);
    ...
    const updateHouseMutation = useMutation({
        mutationFn: ({ jobNo, hawbId, payload }) =>
            updateUbAirInboundHouse(jobNo, hawbId, payload),
