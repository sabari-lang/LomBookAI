...
import { createAirInboundArrivalNotice, updateAirInboundArrivalNotice, getUbAirInboundProvisionals } from "../../../../../../services/personal-effects/airInbound/peAirInboundApi";
...
const CreateArrivalNotice = ({ editData, setEditData }) => {
    ...
    const { data: provisionalApiRaw, isLoading: provisionalsLoading } = useQuery({
        ...
        queryFn: () => getUbAirInboundProvisionals(jobNo, hawb, { page: 1, pageSize: 1000 }), // Fetch all for mapping
