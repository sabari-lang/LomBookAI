...
import { getUbAirInboundCustomerAccounts } from "../../../../../../services/personal-effects/airInbound/peAirInboundApi";


const AccountingEntryDetailed = () => {
    ...
    const { data: apiRaw, isLoading, isError } = useQuery({
        queryKey: ["peUbCustomerAccountingEntries", jobNo, hawb, currentPage, pageSize],
        queryFn: () =>
            getUbAirInboundCustomerAccounts(jobNo, hawb, {
                page: currentPage,
                pageSize,
            }),
                ...
                <div className="tw-bg-white tw-border tw-border-gray-300 tw-rounded-b-lg tw-p-4">
                    ...
                    <div className="d-flex justify-content-between mb-3">
                        ...
                        <div className="d-flex align-items-center gap-2">
                            <label className="mb-0 text-muted small" style={{ fontSize: 12 }}>Search by</label>
                            <input
                                className="form-control"
                                placeholder="Voucher | HAWB | Description | SAC"
                                title="Search by voucher date, HAWB, description or SAC"
                                value={search}
...
export default AccountingEntryDetailed;
