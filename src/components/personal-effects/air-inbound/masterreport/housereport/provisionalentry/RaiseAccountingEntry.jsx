...
const RaiseAccountingEntry = ({ editData }) => {
    ...
    const { data: provisionalApiRaw } = useQuery({
        ...
        queryFn: () => getUbAirInboundProvisionals(jobNo, hawbNo, { page: 1, pageSize: 1000 }),
    ...
    const createMutation = useMutation({
        ...
        onSuccess: () => {
            queryClient.invalidateQueries(["peUbCustomerAccountingEntries", jobNo, hawbNo]);
