...
const ProvisionalEntry = () => {
    ...
    const { data: apiRaw, isLoading } = useQuery({
        ...
        queryFn: () =>
            getUbAirInboundProvisionals(jobNo, hawb, {
                page: currentPage,
    ...
    const deleteMutation = useMutation({
        mutationFn: () => deleteUbAirInboundProvisional(jobNo, hawb),
        onSuccess: () => {
        ...
        <>
            <div className="container-fluid tw-mt-4">
                ...
                <CommonSectionHeader
                    ...
                    onButtonClick={() =>
                        navigate(
                            "/pe/air-inbound/masterreport/housereport/create-provisional"
                        )
                    }
