...
import {
    deleteUbAirInboundVendorAccount,
...
const AccountingEntryVen = () => {
    ...
    const deleteMutation = useMutation({
        mutationFn: () => deleteUbAirInboundVendorAccount(jobNo, hawb),
    ...
    const handleView = (row) => {
        ...
        navigate("/pe/air-inbound/masterreport/housereport/view-vendor-account");
    };
