...
import { getUbAirInboundVendorAccountById } from "../../../../../../services/personal-effects/airInbound/peAirInboundApi";
                                ...
                                <button className="btn btn-sm btn-primary" onClick={() => {
                                    try {
                                        if (pdfUrl) {
                                            ...
                                            if (w) {
                                                // printing a blob URL PDF may require user action; keep simple
                                            }
                                        }
                                    } catch {}
                                }}>Print</button>
