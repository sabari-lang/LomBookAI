...
import { deleteUbAirInboundCustomerAccount, getUbAirInboundCustomerAccounts } from "../../../../../../services/personal-effects/airInbound/peAirInboundApi";
...
const AccountingEntryCus = () => {
    ...
    const refresh = useCallback(() => {
        queryClient.invalidateQueries(["peUbCustomerAccountingEntries"]);
    }, [queryClient]);
    ...
    const { data: apiRaw, isLoading, isError } = useQuery({
        ...
        queryFn: () => getUbAirInboundCustomerAccounts(jobNo, hawb, {
            page: currentPage,
            pageSize,
        }),
    ...
    const deleteMutation = useMutation({
        mutationFn: ({ id }) => deleteUbAirInboundCustomerAccount(id),
        onSuccess: () => {
            queryClient.invalidateQueries(["peUbCustomerAccountingEntries"]);
    ...
    const handleView = (row) => {
        ...
        navigate("/pe/air-inbound/masterreport/housereport/view-customer-account");
    };
