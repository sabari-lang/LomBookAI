...
import { deleteUbAirInboundJob, getUbAirInboundJobs } from "../../../services/personal-effects/airInbound/peAirInboundApi";
...
const AirInboundComp = () => {
    ...
    const deleteMutation = useMutation({
        ...
        onSuccess: () => {
            queryClient.invalidateQueries({ queryKey: ["pe-ub-air-inbound-master"] });
        },
        onSettled: () => {
    ...
    const { data: apiRaw, isLoading, isError } = useQuery({
        queryKey: ["pe-ub-air-inbound-master", currentPage, entriesPerPage],
        queryFn: () =>
            getUbAirInboundJobs({
                page: currentPage,
        ...
        <>
            <div className="container-fluid mt-3">
                ...
                <div className="d-flex justify-content-between align-items-center bg-primary text-white px-3 py-2 rounded-top">
                    <h5 className="m-0">UB Air Inbound</h5>

                    <button
                        className="btn btn-success btn-sm"
                        data-bs-toggle="modal"
                        data-bs-target="#peAirInCreateJobModal"
