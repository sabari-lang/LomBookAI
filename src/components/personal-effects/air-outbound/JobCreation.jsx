...
import { createAirOutboundJob, updateAirOutboundJob } from "../../../services/personal-effects/airOutbound/peAirOutboundApi";
...
const JobCreation = ({ editData, setEditData }) => {
    ...
    useEffect(() => {
        const modalElement = document.getElementById("peAirOutCreateJobModal");
    ...
    const handleCloseModal = () => {
        reset(initialValues);
        setEditData?.(null);
        closeModal("peAirOutCreateJobModal");
        cleanupModalBackdrop();
    };
    ...
    const createMutation = useMutation({
        ...
        onSuccess: () => {
            queryClient.invalidateQueries(["pe-ub-air-outbound-master"]);
