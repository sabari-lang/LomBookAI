...
import { createUbAirOutboundCustomerAccount, updateUbAirOutboundCustomerAccount, getAirOutboundProvisionals } from "../../../../../../services/personal-effects/airOutbound/peAirOutboundApi";
...
const RaiseAccountingEntryOut = ({ editData }) => {
    ...
    const createMutation = useMutation({
        ...
        onSuccess: () => {
            ...
            notifySuccess("UB Air Outbound customer accounting entry created");
    ...
    const updateMutation = useMutation({
        ...
        onSuccess: () => {
            ...
            notifySuccess("UB Air Outbound customer accounting entry updated");
