...
import { createUbAirOutboundProvisional, updateUbAirOutboundProvisional } from "../../../../../../services/personal-effects/airOutbound/peAirOutboundApi";
...
const CreateProvisionalEntryOut = () => {
    ...
    const createMutation = useMutation({
        mutationFn: (payload) => createUbAirOutboundProvisional(ubId, payload),
        onSuccess: () => {
            queryClient.invalidateQueries(["airOutboundProvisionals", ubId]);
    ...
    const updateMutation = useMutation({
        mutationFn: (payload) => updateUbAirOutboundProvisional(ubId, payload),
        onSuccess: () => {
            queryClient.invalidateQueries(["airOutboundProvisionals", ubId]);
            queryClient.invalidateQueries(["airOutboundProvisionals", jobNo, hawbNo]);
