...
import { getUbAirOutboundVendorAccountById } from "../../../../../../services/personal-effects/airOutbound/peAirOutboundApi";
...
const ViewVendorAccountOut = () => {
    ...
    useEffect(() => {
        const stored = sessionStorage.getItem("vendorOutViewData");
        if (stored) {
            try {
                const data = JSON.parse(stored);
                setEntryData(data);
            } catch (e) {
                console.error("Error parsing vendorOutViewData:", e);
            }
        }
    ...
    const { data: fullEntryData } = useQuery({
        queryKey: ["airOutboundVendorAccountEntry", entryData?.id],
        queryFn: () => getAirOutboundVendorAccountById(entryData?.id),
...
export default ViewVendorAccountOut;
