...
import { getUbAirOutboundCustomerAccounts } from "../../../../../../services/personal-effects/airOutbound/peAirOutboundApi";

const AccountingEntryDetailedOut = () => {
    ...
    const { data: apiRaw, isLoading, isError } = useQuery({
        queryKey: ["airOutboundCustomerAcc", jobNo, hawbNo, currentPage, pageSize],
        queryFn: () =>
            getAirOutboundCustomerAccounts(jobNo, hawbNo, {
                page: currentPage,
                pageSize,
            }),
...
export default AccountingEntryDetailedOut;
