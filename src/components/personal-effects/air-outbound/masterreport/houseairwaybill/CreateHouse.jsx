...
import { createUbAirOutboundHouse, updateUbAirOutboundHouse } from "../../../../../services/personal-effects/airOutbound/peAirOutboundApi";
...
const CreateHouse = ({ editData, setEditData }) => {
    ...
    const createAirOutboundHouseMutation = useMutation({
        mutationFn: ({ jobNo, payload }) =>
            createUbAirOutboundHouse(jobNo, payload),

        onSuccess: () => {
            queryClient.invalidateQueries(["peUbAirOutboundHouses", jobNo]);
    ...
    const updateAirOutboundHouseMutation = useMutation({
        mutationFn: ({ jobNo, hawb, payload }) =>
            updateUbAirOutboundHouse(jobNo, hawb, payload),
