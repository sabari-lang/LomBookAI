...
import { deleteUbAirOutboundJob, getUbAirOutboundJobs } from "../../../services/personal-effects/airOutbound/peAirOutboundApi";
...
const AirOutboundComp = () => {
    ...
    const deleteMutation = useMutation({
        ...
        onSuccess: () => {
            queryClient.invalidateQueries({ queryKey: ["pe-ub-air-outbound-master"] });
        },
    ...
    const { data: apiData, isLoading, isError } = useQuery({
        queryKey: ["pe-ub-air-outbound-master"],
        queryFn: getUbAirOutboundJobs,
        retry: 1,
        staleTime: 1000 * 60 * 5,
    });
        ...
        <>
            <div className="container-fluid mt-3">
                ...
                <div className="d-flex justify-content-between align-items-center bg-primary text-white px-3 py-2 rounded-top">
                    <h5 className="m-0">UB Air Outbound</h5>

                    <button
                        className="btn btn-success btn-sm"
                        data-bs-toggle="modal"
                        data-bs-target="#peAirOutCreateJobModal"
