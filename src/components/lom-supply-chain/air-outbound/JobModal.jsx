...
import { createLscAirOutboundTracking, updateLscAirOutboundTracking } from "../../../services/lsc/airOutbound/lscAirOutboundTrackingService";
...
const JobModal = ({ editData, setEditData }) => {
    ...
    const handleCloseModal = () => {
        reset(DEFAULTS);
        setEditData?.(null);
        closeModalUtil("lscAirOutboundJobModal");
        cleanupModalBackdrop();
    };

    // Cleanup on modal close
    useEffect(() => {
        const modalElement = document.getElementById("lscAirOutboundJobModal");
    ...
    const createMutation = useMutation({
        mutationFn: createLscAirOutboundTracking,
        onSuccess: () => {
            queryClient.invalidateQueries(["lscAirOutboundTracking"]);
            notifySuccess("Air Outbound created successfully!");
            handleCloseModal();
        },
        onError: (err) => handleProvisionalError(err, "Create Air Outbound"),
    });

    const updateMutation = useMutation({
        mutationFn: ({ id, payload }) => updateLscAirOutboundTracking(id, payload),
        onSuccess: () => {
            queryClient.invalidateQueries(["lscAirOutboundTracking"]);
            notifySuccess("Air Outbound updated successfully!");
            handleCloseModal();
        },
        onError: (err) => handleProvisionalError(err, "Update Air Outbound"),
    });
            ...
            <div className="modal-dialog modal-lg modal-dialog-centered">
                <div className="modal-content">
                    <div className="modal-header">
                        <h5 className="modal-title fw-bold">Air Outbound</h5>
                        <button
                            type="button"
                            className="btn-close"
                        ...
                        <Controller name="consigneeName" control={control} render={({ field }) => <input {...field} className="form-control" placeholder="Consignee Name" />} />
                                ...
                                <div className="row mb-3">
                                    <div className="col-md-3">
                                        ...
                                        <Controller name="flightName" control={control} render={({ field }) => <input {...field} className="form-control" placeholder="Flight Name" />} />
                                    </div>
                                    <div className="col-md-3">
                                ...
                                <div className="row mb-3">
                                    ...
                                    <div className="col-md-3">
                                        ...
                                        <Controller name="cfsPort" control={control} render={({ field }) => <input {...field} className="form-control" placeholder="CFS / Port" />} />
                                    </div>
                                </div>
                                ...
                                <div className="row mb-3">
                                    ...
                                    <div className="col-md-3">
                                        ...
                                        <Controller name="originalDocument" control={control} render={({ field }) => <input {...field} className="form-control" placeholder="Original Document" />} />
                                    </div>
                                </div>
                                ...
                                <div className="row mb-3">
                                    <div className="col-md-12">
                                        ...
                                        <Controller
                                            name="remarks"
                                            control={control}
                                            render={({ field }) => <textarea {...field} rows={4} className="form-control" placeholder="Remarks"></textarea>}
                                        />
                                    </div>
                                </div>
                            </div>
